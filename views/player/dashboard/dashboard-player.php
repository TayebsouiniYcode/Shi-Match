    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Football Profile Card -->
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow cursor-pointer" onclick="window.location.href='sport-profile-details.html?sport=football'">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">Football</h3>
                                <p class="text-sm text-gray-500">Niveau Intermédiaire</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="text-gray-900">Milieu de terrain</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Équipes:</span>
                                <span class="text-gray-900">2 équipes</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Matches:</span>
                                <span class="text-gray-900">28 matches</span>
                            </div>
                        </div>
                ...
                <!-- Basketball Profile Card -->
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow cursor-pointer" onclick="window.location.href='sport-profile-details.html?sport=basketball'">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">Basketball</h3>
                                <p class="text-sm text-gray-500">Niveau Avancé</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Position:</span>
                                <span class="text-gray-900">Arrière</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Équipes:</span>
                                <span class="text-gray-900">1 équipe</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Matches:</span>
                                <span class="text-gray-900">15 matches</span>
                            </div>
                        </div>
